@mixin primer-colors_v2-dark {
  & {
    ...
    --color-alert-success-text: #3fb950;
    ...
    --color-branch-name-bg: rgba(110,118,129,0.1);
    ...
    --color-search-keyword-hl: rgba(187,128,9,0.15);
    ...
    --color-topic-tag-hover-bg: rgba(56,139,253,0.4);
    ...
    --color-input-disabled-bg: rgba(110,118,129,0.4);
    ...
    --color-timeline-badge-bg: #161b22;
    ...
    --color-diff-addition-text: #3fb950;
    ...
    --color-diff-blob-deletion-num-bg: rgba(248,81,73,0.4);
