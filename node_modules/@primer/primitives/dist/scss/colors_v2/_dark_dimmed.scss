@mixin primer-colors_v2-dark_dimmed {
  & {
    ...
    --color-alert-success-text: #57ab5a;
    ...
    --color-branch-name-bg: rgba(99,110,123,0.1);
    ...
    --color-search-keyword-hl: rgba(174,124,20,0.15);
    ...
    --color-topic-tag-hover-bg: rgba(65,132,228,0.4);
    ...
    --color-input-disabled-bg: rgba(99,110,123,0.4);
    ...
    --color-timeline-badge-bg: #2d333b;
    ...
    --color-diff-addition-text: #57ab5a;
    ...
    --color-diff-blob-deletion-num-bg: rgba(229,83,75,0.4);
